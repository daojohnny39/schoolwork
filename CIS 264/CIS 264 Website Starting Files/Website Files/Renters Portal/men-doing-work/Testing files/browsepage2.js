...
function displayProperties() {
    ...
    properties.forEach(function(property) {
        ...
        const url = new URL('https://drive.google.com/file/d/1sgIVK9mhssCnkUdD_M_z_YJWlmVfywO_/view');
        const viewLink = url.toString();
        imgElement.src = viewLink; // Assuming the image URL is stored in the property object
        ...
        var cityAndStateElement = document.createElement('p');
        cityAndStateElement.textContent = property.city + ', ' + property.state;
        propertyElement.appendChild(cityAndStateElement);
